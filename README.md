...
Para conhecer o painel, clique em:
...
| Atividades imobiliárias | 7,68% | Consumidores residenciais ANEEL como indicador temporal + Denton-Cholette contra benchmark CR IBGE | ANEEL (SAMP) / IBGE – CR |
...
└── notas/
    ├── apresentacoes/            # PDFs, TEX e versões de apresentação
    ├── experimentos/             # laboratórios e testes metodológicos isolados
    ├── metodologia/              # monitoramento, relatórios e notas metodológicas auxiliares
    └── reformas/                 # planos e checklists das frentes metodológicas
```
...
| `notas/metodologia/relatorio_comparacao_projeto_vs_cr.md` | Relatório rápido comparando projeto e Contas Regionais |
